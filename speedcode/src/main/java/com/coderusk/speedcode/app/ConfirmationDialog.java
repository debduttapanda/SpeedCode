...
public class ConfirmationDialog extends PandaDialog {
    Button bt_ok;
    Button bt_cancel;
    TextView tv_text;
    String message;
    ...
    public ConfirmationDialog(Context context, String title, String message, OnActionListener listener) {
        super(context, title);
        this.listener = listener;
        this.layout = R.layout.confirmation_dialog_layout;
