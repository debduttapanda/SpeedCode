package com.coderusk.speedcode.app.cropper;
...
import com.coderusk.speedcode.app.cropper.animation.SimpleValueAnimator;
import com.coderusk.speedcode.app.cropper.animation.SimpleValueAnimatorListener;
import com.coderusk.speedcode.app.cropper.animation.ValueAnimatorV14;
import com.coderusk.speedcode.app.cropper.animation.ValueAnimatorV8;
import com.coderusk.speedcode.app.cropper.callback.Callback;
...
import com.coderusk.speedcode.app.cropper.callback.SaveCallback;
import com.coderusk.speedcode.app.cropper.util.Logger;
import com.coderusk.speedcode.app.cropper.util.Utils;
...
@SuppressWarnings("unused") public class CropImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    int mOutputMaxWidth1 = 0;
    int mOutputMaxHeight1 = 0;
    public void setMaxRect(int width, int height)
    {
        DONT_USEsetOutputMaxSize(width, height);
        fit_flag = FIT_WITHIN;
        mOutputMaxWidth1 = height;
        mOutputMaxHeight1 = width;
    }

    private Bitmap scaleBitmapIfNeeded(Bitmap cropped) {
        if(fit_flag==FIT_WITHIN)
        {
            mOutputMaxWidth = mOutputMaxWidth1;
            mOutputMaxHeight = mOutputMaxHeight1;
        }
     ...
     */
    public void DONT_USEsetOutputMaxSize(int maxWidth, int maxHeight) {
        mOutputMaxWidth = maxWidth;
        mOutputMaxHeight = maxHeight;
    }
    public int FIT_WITHIN = 1;
    public int FIT_HEIGHT = 2;
    public int FIT_WIDTH = 3;

    private int fit_flag = 0;
    public void setFitFlag(int flag)
    {
        fit_flag = flag;
    }
